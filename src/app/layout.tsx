...
export const metadata: Metadata = {
  title: "Morning Brew | Local Coffee Shop",
  description: "Handcrafted espresso drinks and fresh pastries at your neighborhood coffee shop. Visit Morning Brew today.",
  keywords: "coffee shop, espresso, cappuccino, local cafe, specialty coffee",
  openGraph: {
    title: "Morning Brew | Local Coffee Shop",
    description: "Handcrafted espresso drinks and fresh pastries at your neighborhood coffee shop.",
    type: "website",
